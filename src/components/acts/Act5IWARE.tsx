  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <hr className="hairline mb-16" style={{ background: "var(--color-text-primary)", height: "2px" }} />
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <aside className="lg:col-span-4">
            ...
            <ul className="space-y-4 text-2xl">
              {philosophy.map((word, i) => (
                <li key={word} className="flex items-baseline gap-4">
            ...
            <p className="mt-12 text-sm opacity-70 leading-relaxed">
              客製不套版，跟你們對藝術品質的堅持同頻。
            </p>
          </aside>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {cases.map((c) => (
              <article
                key={c.name}
                className="aspect-[4/3] border p-6 flex flex-col justify-between"
